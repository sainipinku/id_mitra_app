...
class AdminUsersDetailsWidgets extends StatefulWidget {
  SchoolDetailsModel? schoolDetailsModel;
  AdminUsersDetailsWidgets({super.key, required this.schoolDetailsModel});

  @override
  State<AdminUsersDetailsWidgets> createState() =>
      _AdminUsersDetailsWidgetsState();
}

class _AdminUsersDetailsWidgetsState extends State<AdminUsersDetailsWidgets> {
  @override
                  ...
                  Container(
                    ...
                    child: Text(
                      ...
                      style: MyStyles.boldText(
                          size: 10, color: AppTheme.activeBtn),
                    ),
                  )
                ],
              ),
