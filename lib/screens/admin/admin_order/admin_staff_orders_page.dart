...
class _AdminStaffOrdersPageState extends State<AdminStaffOrdersPage> {
  ...
  Future<void> _fetch({bool reset = false}) async {
    ...
    try {
      ...
      var url =
          '${Config.baseUrl}auth/partner/orders?page=$currentPage&school_id=${widget.schoolId}';
      ...
      final newOrders = rawList
          .map((e) =>
              AdminStaffOrderItem.fromJson(e as Map<String, dynamic>))
          .toList();
            ...
            child: Column(
              children: [
                ...
                Row(
                  children: [
                    Expanded(
                        child: _dateField(_dateFromCtrl, 'dd-mm-yyyy')),
                    const SizedBox(width: 8),
                    Expanded(
                        child: _dateField(_dateToCtrl, 'dd-mm-yyyy')),
                  ],
                ),
              ],
            ),
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                _infoChip(
                    Icons.calendar_today_outlined, order.orderedAt),
              ],
            ),
          ),
        ],
