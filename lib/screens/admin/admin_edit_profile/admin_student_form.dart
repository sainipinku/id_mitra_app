...
class AdminStudentForm extends StatefulWidget {
  ...
  const AdminStudentForm({super.key, required this.schoolDetailsModel});
                ...
                child: filtered.isEmpty
                  ...
                  itemBuilder: (_, i) {
                    ...
                    return GestureDetector(
                      key: ValueKey(f['name']),
                      onTap: () => setAdd(() =>
                      checked ? selected.remove(i) : selected.add(i)),
                      child: Container(
                  ...
                  children: [
                          ...
                          SizedBox(
                            ...
                            child: AppButton(
                              ...
                              onTap: () => _openAddFields(
                                  setSheet, tempFields, availableFields),
                            ),
                          ),
                        ],
                      ),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: Colors.white,
                        border: Border(
                            top: BorderSide(color: AppTheme.backBtnBgColor)),
                      ),
                      child: Row(
                        children: [
                          Expanded(
                          ...
                          const SizedBox(width: 10),
                          Expanded(
                            child: BlocBuilder<StudentFormCubit,
                                StudentFormState>(
    ...
    return Scaffold(
      ...
      body: BlocBuilder<StudentFormCubit, StudentFormState>(
        builder: (context, state) {
          if (state.loading) return const StudentFormShimmer();
                    ...
                    SizedBox(
                      ...
                      child: AppButton(
                        ...
                        onTap: () => _openConfigure(
                            fields, schoolName, state.availableFields),
                      ),
                    ),
                  ],
                ),
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 4),
                                  Text(
                                      'Configure which fields show on the Add Staff form',
                                      style: MyStyles.regularText(
                                          size: 12,
                                          color: AppTheme.graySubTitleColor)),
                                ],
